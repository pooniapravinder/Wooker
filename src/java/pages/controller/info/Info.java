...
public class Info {
    ...
    public String PrimaryInfoPageView(@RequestParam(value = "sqq", required = false) String getId, HttpServletRequest request, HttpServletResponse response) {
        ...
        return ((id!=null)&&(pattern.matcher(id).matches())&&(Long.valueOf(id)!=user)) ? "otheruserinfo" : "info";
    }
