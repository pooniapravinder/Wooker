...
public class SpamMessages {
    ...
    public List firstSpamPageMessage(long user) {
        Session sess = null;
        Transaction tx = null;
        List listdata = null;
        try {
    ...
    public List SpamMessage(long user, long pagination_id, boolean isForward) {
        Session sess = null;
        Transaction tx = null;
        List listdata = null;
        try {
