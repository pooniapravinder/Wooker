...
public class BlockedMessages {
    ...
    public List firstBlockedPageMessage(long user) {
        Session sess = null;
        Transaction tx = null;
        List listdata = null;
        try {
    ...
    public List BlockedMessage(long user, long pagination_id, boolean isForward) {
        Session sess = null;
        Transaction tx = null;
        List listdata = null;
        try {
