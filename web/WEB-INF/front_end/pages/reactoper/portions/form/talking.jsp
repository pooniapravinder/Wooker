<div class="fdger_ghfdfd">
    ...
    <div class="tty_da_das">
        <form:form method="post" name="talking" modelAttribute="talking" action="${requestURI}?sqq=${crypto.encodeURL(param.sqq)}&refer=mrPdk_dm-dnn_dk&prerefer=${crypto.encodeURL(param.refer)}" enctype="multipart/form-data">
            <div class="dfhf_sd_hg">
                <form:textarea path="talking" id="hfgh_hfhf" class="frrt_zxfsr" placeholder="...." autocorrect="off" autocomplete="off" spellcheck="false"/>
            ...
            <div class="gtrev_gfg yr_yu">
                ...
                <form:button name="talkit" id="talkit" class="form_talk_button" value="submit">Talk it</form:button>
            </div>
        </form:form>
    </div>
</div>