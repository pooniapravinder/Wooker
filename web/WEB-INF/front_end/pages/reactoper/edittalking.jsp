...
<html lang="en-US" id="wooker">
    <head><c:set var="requestURI" value="${requestScope['javax.servlet.forward.request_uri']}"/>
        <meta name="keywords" content="Edit Talking at Wooker">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no">
        <meta name="theme-color" content="#663399">
        <link rel="shortcut icon" href="//www.google.com/favicon.ico"/>
        <meta name="description" content="Edit Talking at Wooker">
        <meta name="google" content="notranslate">
        <title>Edit Talking</title>
    ...
    <body>
        ...
        <div class="wrapper animate_in" id="wrapper">
            ...
            <div class="content">
                ...
                <%@include file="portions/showdata/edittalkingtop.jsp"%>
                <div class="ttt_p"></div>
                <div class="yl__p"></div>

                <c:set var="talkings" value="${ReactData.getEditedTalk(userSqq.operId,page)}"/>
                ...
                <%@include file="portions/showdata/edittalking.jsp"%>
                <c:if test="${(userSqq.userOne==user)&&(!isDisabled)}">
                    <%@include file="portions/form/edittalking.jsp"%>
                </c:if>
                <c:if test="${isDisabled}">
                    <div class="htul tty_da_das">
                    <span class="fght_fgd">You must enable talking first on previous page</span>
                    </div>
                </c:if>
