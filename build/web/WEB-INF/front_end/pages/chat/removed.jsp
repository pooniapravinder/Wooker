...
<html lang="en-US" id="wooker"><c:set var="requestURI" value="${requestScope['javax.servlet.forward.request_uri']}"/>
    ...
    <body>
        <%@include file="../header.jsp"%>
            ...
            <jsp:useBean id="getMessages" class="hibernate.query.chat.RemovedMessages"/>
            ...
            <c:choose>
                <c:when test="${(crypto.decrypt(param.pagination_backward))!=null}">
                    ...
                    <c:set var="messages" value="${getMessages.RemovedMessage(user,pagination_backward,false)}"/>
                </c:when>
                <c:when test="${(crypto.decrypt(param.pagination_forward))!=null}">
                    ...
                    <c:set var="messages" value="${getMessages.RemovedMessage(user,pagination_forward,true)}"/>
                </c:when>
                <c:otherwise>
                    <c:set var="messages" value="${getMessages.firstRemovedPageMessage(user)}"/>
                </c:otherwise>
            </c:choose>
