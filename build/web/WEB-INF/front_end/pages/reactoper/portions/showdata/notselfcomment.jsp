<div class="yl__p"></div>
<c:set var="comments" value="${ReactData.getComments(false,user,crypto.decrypt(param.sqq),page)}"/>
<c:set var="totalPage" value="${ReactData.getCommentTotalPage(false,user,crypto.decrypt(param.sqq))}"/>
    ...
    <div class="fdger_ghfdfd">
        ...
        <div class="_fgfd_bfdg">
            ...
            <div class="yk__p">
                ...
                <c:if test="${(user==data.userOne)&&(!data.selfUser)&&(!data.edited)}">
                ...
                <c:if test="${((user==data.userOne)&&(!data.selfUser)) || ((user==data.userTwo)&&(data.selfUser))}">
