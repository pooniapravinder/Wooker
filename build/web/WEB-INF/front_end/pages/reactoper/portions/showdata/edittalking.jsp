...
<c:set var="totalPage" value="${ReactData.getEditTotalPage(userSqq.operId)}"/>
...
<c:forEach items="${talkings}" var="data">
    ...
    <div class="fdger_ghfdfd">
        ...
        <div class="_fgfd_bfdg">
            <div class="uu_pp">
                <div class="gr_ds_dssd">${talkerInfo.firstName} ${talkerInfo.lastName}</div><div class="ytr__hgfh">${CalTime.time}</div>
            </div>
            <div class="de_gh">
