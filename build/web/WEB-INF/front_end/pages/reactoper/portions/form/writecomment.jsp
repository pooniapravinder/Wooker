<div class="fdger_ghfdfd">
    ...
    <div class="tty_da_das">
        <form:form method="post" name="writecomment" modelAttribute="writecomment" action="${requestURI}?sqq=${crypto.encodeURL(param.sqq)}&user=${crypto.encodeURL(param.user)}&refer=NoeKmf-F_fkERMl&prerefer=${crypto.encodeURL(param.prerefer)}" enctype="multipart/form-data">
            <div class="dfhf_sd_hg">
                <form:textarea path="comment" id="hfgh_hfhf" class="frrt_zxfsr" placeholder="...." autocorrect="off" autocomplete="off" spellcheck="false"/>
            ...
            <div class="gtrev_gfg yr_yu">
                ...
                <form:button name="talkit" id="talkit" class="form_comment_button" value="submit">Write</form:button>
            </div>
        </form:form>
    </div>
</div>