<div class="fdger_ghfdfd">
    ...
    <div class="tty_da_das">
        <form:form method="post" name="comment" modelAttribute="comment" action="${requestURI}?sqq=${crypto.encodeURL(param.sqq)}&refer=vbYUn-MnIOA_sEL&prerefer=${crypto.encodeURL(param.refer)}" enctype="multipart/form-data">
            ...
            <div class="gtrev_gfg yr_yu">
                ...
                <form:button name="talkit" id="talkit" class="form_comment_button" value="submit">Comment</form:button>
            </div>
        </form:form>
    </div>
</div>